...
# from hihi.utils.ssi import config
from hihi.db.dao.predefined_indicator_dao import PredefinedIndicatorDAO
from hihi.db.dao.predefined_param_dao import PredefinedParamDAO
from hihi.db.dao.predefined_return_dao import PredefinedReturnDAO
from hihi.db.dao.stock_dao import StockDAO


async def insert_predefined_data():
    with open(
        "hihi/data/predefined_indicators.json",
        "r",
    ) as f:
        data = json.load(f)
